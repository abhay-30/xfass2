...
def create_resources(resource_dir, out_file_path, region,is_netherite):
    ...
    try:
        ...
        print("resouce group created successfully*****************************************************************************" + resource_group_name)
    ...
    try:
        ...
        print("storage account created successfully ******************************************************************************" + storage_account_name)
    ...
    if is_netherite:
        ...
        try:
            ...
            json_str = stream.read()
            stream.close()
            print('event hub created successfully***************************************************************')
        except Exception as e:
            print(e)
        ...
        print('event hub not required  successfully***************************************************************')
...
#dangerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
    ...
    #addedd by me  ------------------------------------------------------------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    storage_account_name = "serwoa1"
    resource_group_name= "second_one"
    try:
