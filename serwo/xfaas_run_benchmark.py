...
def template_azure_jmx_file(rps, duration, execute_url, payload_size, input_jmx, output_path, session_id,payload):
    ...
    #my code here 
    input_jmx = '/home/oem/Desktop/xfaas_refactor/XFaaS/serwo/benchmark_resources/azure_jmx_template.jmx'
    ...
    #my code here 
    output_path ='/home/oem/Desktop/xfaas_refactor/XFaaS/serwo/benchmark_resources/generated_jmx_resources/azure-graph-medium-static-1-300-session-staticmedium1.jmx'
...
def get_jmx_paths(csp, rps, duration, payload_size, wf_name, dynamism, session_id):
    ...
    #my code here 
    jmx_output_path='/home/oem/Desktop/xfaas_refactor/XFaaS/serwo/benchmark_resources/generated_jmx_resources/azure-graph-medium-static-1-300-session-staticmedium1.jmx'
...
def generate_shell_script_and_scp(csp,payload_size, wf_name, rps, duration,dynamism):
    ...
    for command in shell_script_commands:
        ...
        # code += "sleep 20\n"
        #my code here 
        output_path= '/home/oem/Desktop/xfaas_refactor/XFaaS/serwo/benchmark_resources/generated_shell_scripts/azure-medium-graph-1-300.0-static.sh'
    with open(output_path, "w") as f:
        f.write(code)
