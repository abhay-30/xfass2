...
def add_collect_logs(dag_definition_path,user_wf_dir, xfaas_user_dag):
    ...
    collect_logs_dir = f'{project_dir}/templates/azure/predefined-functions/CollectLogs'   #func.py and requiements.txt file present 
    ...
    storage_account_name = "xfaasstoragenew"
   
    queue_name = randomString(5)
    print("*****************Queue name for xfassstorage is **********" + queue_name)
    ...
    try:
        ...
        print("resource group created successfully ******************************************************************* "+ resource_group_name)
    ...
    try:
        ...
        print("storage is created successfully *************************************************************" + storage_account_name)
    except Exception as e:
        print(e)
    ...
    try:
        ...
        print("Queue created successfully**********************************************************************"+ queue_name)
    except Exception as e:
        print(e)
    ...
    try:
        ...
        print('obatinging string for this account ***********************************************************************')
        print(json_str)
        stream.close()
    except Exception as e:
        print(e)
    ...
    print(user_wf_dir)
    print(collect_logs_dir)
    print(new_collect_logs_dir)
